# EKS Cluster w/ EKS Managed Node Group & SSM Parameter Store

Demonstrates how an AMI ID can be automatically resolved from an SSM parameter ([reference](https://docs.aws.amazon.com/eks/latest/userguide/retrieve-ami-id.html))
